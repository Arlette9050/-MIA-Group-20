...
def intensity_based_registration_demo(murange):
    ...
    for mu in murange:
        ...
        fun = lambda x: reg.affine_mi(I, Im, x, return_transform=False, fast=True)
        ...
        for k in np.arange(num_iter):   
            ...
            S, Im_t, _ = reg.affine_mi(I, Im, x, return_transform=True, fast=True)
